...
import {FieldTile, ObjectTile, SimpleTile} from "./Tile";
import {Appender} from "../Appender";

describe("ObjectTile", () => {
    it("No fields", () => {
        const objectTile = new ObjectTile([]);
        assertThat(objectTile).is({elements: [], stringLength: 2, complexity: 2});
    ...
    it("One field", () => {
        ...
        assertThat(objectTile).is({elements: [tile], stringLength: 10, complexity: 4});
    });
    ...
    it("Three fields", () => {
        ...
        assertThat(objectTile).is({elements: [tile1, tile2, tile3], stringLength: 30, complexity: 8});
    });
});
