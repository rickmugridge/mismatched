...
describe("PseudoCallTile", () => {
    it("Undefined arguments", () => {
        ...
        assertThat(arrayTile).is(
            {callName: "target.meth", stringLength: 3, complexity: 1, withSquareBrackets: false});
    ...
    it("No arguments", () => {
        ...
        assertThat(arrayTile).is(
            {callName: "target.meth", args: [], stringLength: 11, complexity: 3, withSquareBrackets: false});
        assertThat(Appender.composeTile(arrayTile)).is("target.meth()");
    });
    ...
    it("One argument", () => {
        ...
        assertThat(arrayTile).is(
            {callName: "fn", args: [tile], stringLength: 9, complexity: 4, withSquareBrackets: false});
