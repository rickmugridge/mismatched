...
describe("match.obj.match:", () => {
    ...
    const failsWith = (actual: any, expected: any, failsWith: any, errors: string[]) => {
    ...
    describe('Fails to match as:', () => {
        ...
        describe('missing:', () => {
            it('1. missing field', () => {
                failsWith({f: 3}, {f: 3, g: 4},
                    ...
                    ['{"actual.g": undefined, expected: 4}']) // todo not correct
            })

            it('2. missing field, when no actual fields', () => {
                failsWith({}, {g: 3},
                    {g: {[MatchResult.expected]: 3}},
                    ['{"actual.g": undefined, expected: 3}']) // todo not correct
            });
        ...
        describe('extra:', () => {
            it('extra field', () => {
                failsWith({f: 2, g: 3}, {f: 2},
                    ...
                    ["{actual: {f: 2, g: 3}, unexpected: {g: 3}}"])// todo not correct
            })

            it('extra field when expecting no fields', () => {
                failsWith({f: 2, g: 3}, {},
                    {[MatchResult.unexpected]: {f: 2, g: 3}},
                    ["{actual: {f: 2, g: 3}, unexpected: {f: 2, g: 3}}"])// todo not correct
            })
        })
        ...
        it("Needs an actual object", () => {
            failsWith(undefined, {f: 2},
                ...
                ['{actual: undefined, expected: "object expected"}'])// todo not correct
            failsWith(2, {f: 2},
                {[MatchResult.was]: 2, [MatchResult.expected]: {f: 2}},
                ['{actual: 2, expected: "object expected"}']) // todo not correct
        })
        ...
        it("has a missing key", () => {
            failsWith({f: 3, g: 4}, {f: match.obj.key(2), g: 5},
                ...
                ['{"actual.f": 3, expected: 2}', '{"actual.g": 4, expected: 5}']) // todo not correct
        })
